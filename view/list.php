        ...
        <div class="col-md-12">
            ...
            <table class="table table-striped">
                ...
                <?php if ($path != '/'): ?>
                    <tr>
                        <td class="file-name">
                            <span class="fa fa-folder-open-o"><a class="icon icon-up"
                                                               href="<?php echo get_absolute_path($root_path . $path . '../'); ?>">&nbsp;..</a>
                        </td>
                ...
                <?php foreach ((array)$items as $item): ?>
                    <?php if (!empty($item['folder'])): ?>
                        <tr>
                            <td class="file-name"><span class="fa fa-folder-open">&nbsp;&nbsp;&nbsp;<a
                                            class="icon icon-dir"
                                            href="<?php echo get_absolute_path($root_path . $path) . $item['name']; ?>"><?php echo $item['name']; ?>
                                        /</a></td>
                    ...
                    <?php else: ?>
                        <tr>
                            <td class="file-name"><span class="fa fa-folder-open-o">&nbsp;&nbsp;&nbsp;<a
                                            class="icon icon-file"
                                            href="<?php echo get_absolute_path($root_path . $path) . $item['name']; ?>"><?php echo $item['name']; ?></a>
                            </td>
                            <td class="file-size"><?php echo $item['size']; ?></td>
                            <td class="file-date-created"><?php echo date("Y-m-d H:i:s", $item['createdDateTime']); ?></td>
                            <td class="file-date-modified"><?php echo date("Y-m-d H:i:s", $item['lastModifiedDateTime']); ?></td>
